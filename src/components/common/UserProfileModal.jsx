  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="relative w-full max-w-sm overflow-hidden rounded-3xl border border-[#202635]/[0.09] bg-[#0b1020] p-6 shadow-2xl">
        <button
          onClick={onClose}
          className="absolute right-4 top-4 rounded-full p-2 text-[#f7f3ea]/50 transition hover:bg-white/5 hover:text-white"
        >
          <X size={18} />
        </button>

        {loading ? (
          <div className="flex h-40 items-center justify-center text-sm text-[#f7f3ea]/50">
            Loading profile...
          </div>
        ) : profile ? (
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="text-xl font-bold text-[#f7f3ea]">
            ...
            {profile.bio && (
              <p className="mt-4 text-sm text-[#f7f3ea]/70 leading-relaxed">
                {profile.bio}
              </p>
            )}
            ...
            <div className="mt-8 flex w-full gap-3">
              {currentUser?.id !== userId ? (
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#d9b86c] py-3 text-sm font-bold text-[#17130a] transition hover:bg-[#c4a45b] disabled:opacity-50"
                >
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl border border-[#202635] bg-white/5 py-3 text-sm font-bold text-[#f7f3ea] transition hover:bg-white/10"
                >
                  Edit My Profile
                </button>
              )}
